...
SingupVendor extends AppCompatActivity implements API_Result {
    Spinner selection;
    String query;
    InputStream is = null;
    String result = "";
    ...
    EditText get_vendor_name, get_last_name, get_pwd, get_website, get_project, get_adhar, get_email, get_city, get_mobile, get_confirm_password, get_address, get_pincode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_singup_vendor);
       ...
       /* if (NetworkConnection.connectionChecking(getApplicationContext())) {
        ...
        get_vendor_name = (EditText) findViewById(R.id.et_vendor_name);
        ...
        submit = (Button) findViewById(R.id.btn_submit1);
...
//        go_login_page.setPaintFlags(go_login_page.getPaintFlags() | Paint.UNDERLINE_TEXT_FLAG);
...

        {
            ...
            public void onClick(View v) {
                ...
                if (getPostDataString() != null) {
                    ...
                    String url[] = {URL_Class.mURL + URL_Class.mURL_Registration_vendor};
    ...
    public void transfer() {
        if (DataStorage.mRetrieveSharedPreferenceString(getApplicationContext(), JSON_Names.KEY_CURRENT_LOGIN).equals(JSON_Names.KEY_CURRENT_LOGIN_SIGN_UP)) {
            ...
            Intent intent = new Intent(getApplicationContext(), SingupVendor.class);
    ...
    private String getPostDataString() {
        try {
            ...
            postDataParams.put("vendorname", get_vendor_name.getText().toString());
            postDataParams.put("email", get_email.getText().toString());
            postDataParams.put("mobile", get_mobile.getText().toString());
            postDataParams.put("address", get_address.getText().toString());
            postDataParams.put("adharnumber", get_adhar.getText().toString());
            ...
            if (data != null) {
                ...
                if (response != null) {
                    if (response.getmStatus() == 200) {
                        ...
                        Intent intent = new Intent(SingupVendor.this, Login.class);
                        startActivity(intent);
