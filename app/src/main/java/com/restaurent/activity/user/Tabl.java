...
public class Tabl extends  AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        GridLayoutManager lLayout = new GridLayoutManager(Tabl.this, 2);
      ...
      /*
        ...
        final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Tabl.this);
...
check=(Button)findViewById(R.id.btn_check);
    ...
    protected Dialog onCreateDialog(int id) {
        switch (id) {
            case DATE_DIALOG_ID:
                ...
                _date = new DatePickerDialog(Tabl.this, datePickerListener, myear, mmonth,
                        mday) {
                    @Override
    ...
    public void Check_tables() {
        ...
        progressDialog = new ProgressDialog(Tabl.this);
        progressDialog.show();
        ...
        protected void onPostExecute(String s) {
            try {
                ...
                for (int i = 0; i < sportarraydata2.length(); i++) {
                    ...
                    test_adapter = new style_adapter(Tabl.this, listItemsList);
