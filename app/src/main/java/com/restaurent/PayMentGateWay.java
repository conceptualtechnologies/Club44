...
/**
 * Created by Kaushal on 19/10/16.
 */
...
//    String salt="ZhraT96O"; // live
    ...
    String merchant_key="msmP5mfw"; // test
    String salt="L1JCakLhQg"; // test
	 	String action1 ="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //checkOutAPIRequest = (CheckOutAPIRequest) PayMentGateWay.this;
        ...
        public void success(long id, final String paymentId) {
            mHandler.post(new Runnable() {
                public void run() {
                   ...
                   /* Intent intent=new Intent(PayMentGateWay.this,PayuActivity.class);
